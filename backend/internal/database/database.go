...
func InitDB(dbPath string) (*gorm.DB, error) {
	...
	err = db.AutoMigrate(
		...
		&models.ProxyUser{}, &models.UserNodeTraffic{}, &models.TrafficRecord{}, &models.PanelSetting{}, &models.RemoteServer{}, &models.RemoteNodeMirror{}, &models.ProxyUserRemoteNode{},
	)
	if err != nil {
