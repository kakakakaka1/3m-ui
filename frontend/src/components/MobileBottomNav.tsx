...
const MobileBottomNav: React.FC = () => {
  ...
  const allItems: NavItem[] = useMemo(
    () => [
      ...
      { key: '/listeners', icon: <NodeIndexOutlined />, label: t('nav.listeners'), primary: true },
      { key: '/users', icon: <UserOutlined />, label: t('nav.users'), primary: true },
      { key: '/traffic', icon: <LineChartOutlined />, label: t('nav.traffic'), primary: true },
